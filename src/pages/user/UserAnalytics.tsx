...
// Skeleton row for table during loading
const SkeletonRow = () => (
  <TableRow>
    {[...Array(6)].map((_, idx) => (
      <TableCell key={idx}>
    ...
    <div className="container mx-auto p-6 space-y-8">
      ...
      <Card className="bg-primary/5">
        ...
        <CardContent className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-4 flex-wrap">
            <Button onClick={() => navigate("/user/send-money")} variant="default">
              Send Money
            </Button>
            <Button onClick={() => navigate("/user/withdraw-money")} variant="default">
              Withdraw
            </Button>
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader className="flex justify-between items-center">
          ...
          <Button size="sm" onClick={() => navigate("/user/transactions")}>
