...
import { useAddAgentMoneyMutation } from "@/redux/feature/wallet/wallet.api";
...
const AddAgentMoneyForm = ({
  ...
  const [addMoney, { isLoading }] = useAddAgentMoneyMutation();
  ...
  return (
     <Card className={cn("max-w-md mx-auto shadow-lg border border-gray-200", className)} {...props}>
      <CardHeader className="text-center bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-t-lg py-4">
        <CardTitle className="text-2xl font-bold">Add money to agent</CardTitle>
      </CardHeader>
...
export default AddAgentMoneyForm;
